...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="addPelajar.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="addPelajar.php"><i class="fa fa-circle-o"></i> Pelajar</a></li>
          </ul>
        </li>
        <li>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="addPelajar.php"><i class="fa fa-user-plus"></i> Daftar Pengguna</a></li>
                    ...
                    <form action="tambahPelajar.php" method="POST">
                      <fieldset> 
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="fname" class="form-control" placeholder="Nama penuh pelajar.." required>
                        </div>
