...
<div id="wrapper">
  ...
  <nav class="top1 navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="dashboardpensyarah.php">Pensyarah</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <!-- dropdown account-->
          <li class="dropdown">
            ...
            <li class="m_2"><a href="profilepensyarah.php"><i class="fa fa-user"></i> User</a></li>
            <li class="m_2"><a href="kemaskinipensyarah.php?id_edit=<?php echo $lapoA['id']; ?>"><i class="fa fa-wrench"></i> Update Detail</a></li>
                    ...
                    <ul class="nav" id="side-menu">
                      ...
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                         ...
                         <!-- menu dashbaord pensyarah-->
                        <li>
                            <a href="dashboardpensyarah.php"><i class="fa fa-dashboard"></i>&nbsp Dashboard</a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="entpensyarah.php">Entrance Survey</a>
                                </li>
                                <li>
                                    <a href="extpensyarah.php">Exit Survey</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
...
<script>
        ...
        <div class="col_3">
          <!--title-->
                 ...
                 <div class="col-md-13 span_7">
                      ...
                      <fieldset> 
                        ...
                        <div class="form-group">
                          <h2>Kemaskini Maklumat Pensyarah</h2><br>
            ...
            <!-- submit and reset-->
                        <div class="form-group">
                          <button type="submit" data-confirm="Simpan kemaskini?" class="btn btn-primary">Update</button>
                        </div>
