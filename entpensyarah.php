...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="entpensyarah.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="entpensyarah.php"><i class="fa fa-circle-o text-aqua"></i> Entrance Survey</a></li>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="entpensyarah.php"><i class="fa fa-file-text"></i> Analisis dan Laporan</a></li>
         ...
         <!-- BOX -->
          <div class="box box-info">
              <div class="box-header with-border">
                  <h3 class="box-title">Analisis dan Laporan Entrance Survey</h3>
              </div>
            <div class="box-body">
