...
<body id="login">
  ...
  <div class="app-cam">
    ...
    <?php } ?>
    <form action="proseslogin.php" method="post" autocomplete="on">
    ...
    <div class="password-wrap">
      <input class="input-field" id="userLoginPass" type="password" name="pass" placeholder="Password" required autocomplete="current-password">
      <button type="button" class="password-toggle" id="userTogglePass" aria-label="Tunjuk atau sembunyikan kata laluan" tabindex="0">
        <i class="fa fa-eye" id="userTogglePassIcon" aria-hidden="true"></i>
      </button>
    </div>
    ...
    <ul class="new">
      <li class="new_left"><p><a href="forgotpassword.php?type=user">Forgot Password ?</a></p></li>
...
<script>
(function () {
  var toggleBtn = document.getElementById('userTogglePass')
  var passInput = document.getElementById('userLoginPass')
  var icon = document.getElementById('userTogglePassIcon')
