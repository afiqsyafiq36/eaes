...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="rekodext.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="rekodext.php"><i class="fa fa-circle-o text"></i> Exit Survey</a></li>
          </ul>
        </li>
 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="rekodext.php"><i class="fa fa-inbox"></i> Rekod</a></li>
         ...
         <!-- BOX -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Rekod Borang Exit Survey</h3>
            </div>
            <div class="box-body">
...
$namapenuh = $_SESSION['fullname'];
  $no = 1; //untuk bilangan data dalam DB
   $extE = mysqli_query($hubung,"SELECT kodkursus,fullname,ext_tarikh FROM ext WHERE fullname = '$namapenuh' ");
   $kiraZ = mysqli_num_rows($extE);
    /* $kodkursus = $kira['kodkursus'];
     $fullname = $kira['fullname'];
     $ent_tarikh = $kira['ent_tarikh'];*/

     while ($tetB = mysqli_fetch_array($extE)){

?>
                                        
                                        <tr>
                                          <td><?php echo $tetB['kodkursus']; ?></td>
                                          <td><?php echo $tetB['fullname']; ?></td>
                                          <td><?php echo $tetB['ext_tarikh']; ?></td>
                                        </tr>
<?php
...
?>
                                        ...
                                        <tr> 
                                          <td colspan="3">Jumlah borang Exit Survey yang anda telah lengkapkan : 
                                            <?php 
                                            if ($kiraZ == "0"){
                                                echo "Tiada";
                                            } 
