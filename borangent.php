...
if(isset($_POST['kursus'])) {
    ...
    // variable
     ...
     $tarikh = date("d/m/Y");
      ...
      $rap = mysqli_query($hubung,"SELECT * FROM entrance WHERE fullname = '$icx' AND kodkursus = '$kursus'");
      $z1 = mysqli_fetch_array($rap);
      $R1 = $z1['kodkursus'];
      $R2 = $z1['fullname'];
      $recd = mysqli_num_rows($rap);
     ...
     if ($recd == 0 ) {
                 ...
                 $_SESSION['status'] = "Tahniah! anda telah melengkapkan Entrance Survey ini.";
                 $_SESSION['status_code'] = "success";
                 
            
      }
    
      elseif ($kursus == $R1 && $nama == $R2) {

        $_SESSION['status'] = "Anda telah melengkapkan Entrance Survey bagi kursus ini.";
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="borangent.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="borangent.php"><i class="fa fa-circle-o text-aqua"></i> Entrance Survey</a></li>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="borangent.php"><i class="fa fa-file-text"></i> Borang</a></li>
         ...
         <!-- BOX -->
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Borang Entrance Survey</h3>
