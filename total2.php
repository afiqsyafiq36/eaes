         ...
         <!-- BOX -->
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Rekod Borang Soal Selidik Exit Survey</h3>
            </div>
            <!-- / box header-->
...
<?php
   ...
   $ext = mysqli_query($hubung,"SELECT idExt,kodkursus,fullname,ext_tarikh FROM ext ORDER BY idExt DESC");
   $kira = mysqli_num_rows($ext);

while($info = mysqli_fetch_array($ext)) {
...
?>
                  ...
                  <tr>
                    ...
                    <td><a type="submit" data-confirm="Data yang dipadam tidak akan kembali!" class="btn btn-sm btn-danger" href="deletesurvey2.php?id_delete=<?php echo $info['idExt']; ?>"><i class="fa fa-trash-o"></i></a></td>
                  </tr>
<?php
$no++;
}
?>
          ...
          <div class="row">
           <div class="col-sm-5">
               <div class="dataTables_info" id="example_info" role="status" aria-live="polite">Showing table 2 of 2</div>
           </div>
           <div class="col-sm-7">
               ...
               <div class="dataTables_paginate paging_simple_numbers" id="example1_paginate">
                <ul class="pagination">
                  <li class="paginate_button previous">
                    <a href="total.php" aria-controls="example1" data-dt-idx="0" tabindex="0">Previous</a>
                  </li>
                  <li class="paginate_button">
                    <a href="total.php" aria-controls="example1" data-dt-idx="1" tabindex="0">1</a>
                  </li>
                  <li class="paginate_button active">
                    <a href="#" aria-controls="example1" data-dt-idx="2" tabindex="0">2</a>
                  </li>
                  <li class="paginate_button next disabled" id="example1_next">
                    <a href="#" aria-controls="example1" data-dt-idx="3" tabindex="0">Next</a>
                  </li>
                </ul>
              </div>
