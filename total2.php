...
?>
                  ...
                  <tr>
                    ...
                    <td><button type="submit" id="deleteBtn" class="btn btn-sm btn-danger" value="<?php echo $info['idExt']; ?>"><i class="fa fa-trash-o"></i></a></td>
                  </tr>
<?php
$no++;
}
  ...
  $(document).on('click', '#deleteBtn', function(e){
        ...
        swal({
          ...
          if (willDelete) {
            ...
            window.location.href = "deletesurvey2.php?id_delete="+$(this).val();
          } 
        });
  });
</script> 
