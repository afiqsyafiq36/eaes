...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="entextpensyarah.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="entextpensyarah.php"><i class="fa fa-circle-o"></i> Entrance & Exit Survey</a></li>
          </ul>
        </li>
        <li>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="entextpensyarah.php"><i class="fa fa-file-text"></i> Analisis dan Laporan</a></li>
