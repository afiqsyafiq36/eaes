...
//fungsi ent/ext
$entE = mysqli_query($hubung,"SELECT * FROM entrance WHERE fullname = '$namapenuh' ");
$kiraS = mysqli_num_rows($entE);

$extF = mysqli_query($hubung,"SELECT * FROM ext WHERE fullname = '$namapenuh' ");
$kiraD = mysqli_num_rows($extF);
...
//fungsi total student online
$kiraOnline = mysqli_query($hubung,"SELECT level,status FROM user WHERE status = '1' AND level = '1' ");
$totalOnlinePel = mysqli_num_rows($kiraOnline);

//fungsi total lecturer online
$kira2Online = mysqli_query($hubung,"SELECT level,status FROM user WHERE status = '1' AND level = '2' ");
$totalOnlinePen = mysqli_num_rows($kira2Online);
...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="dashboardpelajar.php" class="logo">
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="dashboardpelajar.php"><i class="fa fa-dashboard"></i> Home</a></li>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php echo $kiraS; ?></h3>

              <p>Entrance Complete</p>
            </div>
            <div class="icon">
              <i class="ion ion-document-text"></i>
            </div>
            <a href="rekodent.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="rekodext.php" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <a  class="small-box-footer">Info </a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
